    ...
    if (hSettings.sKeyProperty) {
        ...
        if (hSettings.hMetrics) {
            ...
            for (var sMetric in hSettings.hMetrics) {
                if (hSettings.hMetrics[sMetric].sAlias)
                    oSelf.hEndpointKeywords['metric'].push({bMetric:true,sEndpoint:'/metric/'+sClass.toLowerCase()+'/'+hSettings.hMetrics[sMetric].sAlias,sClass:sClass});
            }
