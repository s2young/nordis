 ...
 * @param oObj
 */
p.fatal = function (sMsg, bExit, stack) {
    var oSelf = this;
    var stack = stack || new Error().stack;
    oSelf.logger.error('FATAL: ' + sMsg.toString(),stack);
    if (oSelf.fnFatalErrorHandler) {
        oSelf.fnFatalErrorHandler(sMsg,stack,oSelf,function(){
