...
p.fatal = function (sMsg, oObj) {
    ...
    oSelf.logger.error('FATAL: ' + sMsg.toString(), oObj);
    oSelf.emit('onFatalError',oObj);
};
/**
...
p.instance = function(hOpts) {
//    console.log(hOpts);
//    if (hOpts.NORDIS_ENV_ROOT_DIR)
//        console.log(require(hOpts.NORDIS_ENV_ROOT_DIR+'/package.json').name);
    this.inst = new AppConfig(hOpts);
    return this.inst;
};
