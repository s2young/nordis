        ...
        if (oSelf.hStats[sStat].fnQuery || oSelf.hStats[sStat].fnValidate) {
            if (oSelf.hClasses[sStat])
                ...
                oSelf.hClasses[sStat] = {
                    ...
                    ,bSingleton:true
                    ,hProperties:{
                        sid:{bPrimary:true,sType:'String',sValue:sStat,sMySqlType:'CHAR(100)'}
                        ,notes:{sType:'String'}
                    }
                    ,hExtras:{}
                };
                ...
                ['hour','day','month','year','all'].forEach(function(sGrain){
                    ...
                    oSelf.hClasses.Stat.hApi.hEndpoints['/stat/'+sStat+'/{grain}'].hParameters = {
                        grain:{
                            ...
                            ,sType:'String'
                            ,sExample:'hour'
                            ,sDescription:'String name of desired granularity. Acceptable values include hour, day, month, year or all.'
                        }
                    };
                ...
                console.log(oSelf.hClasses.Stat.hApi);
