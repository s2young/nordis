                        ...
                        async.parallel([
                            ...
                            ,function(cb3) {
                                ...
                                if (hOpts.year) {
                                    ...
                                    hDates.dStart = dStart.toDate();
                                    hDates.nMin = dStart.valueOf();
                                    hDates.dEnd = dEnd.toDate();
                                    hDates.nMax = dEnd.valueOf();
                                }
                                new Collection({sClass:hSettings.sClass,sSource:'MySql',nSize:1,hQuery:hSettings.fnQuery(hDates,oSelf)},cb3);
                            }
