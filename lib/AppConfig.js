...
p.publish = function (oObj, hMsg, fnCallback) {
    var oSelf = this;
    var sID = oObj.getClass()+':'+(oObj.getStrKey()||oObj.getKey());
    var sData;
    var hObj;
    if (hMsg.hData) {
        hMsg.hData.nClass = hMsg.nClass;
        hMsg.hData.sClass = hMsg.sClass;
        sData = JSON.stringify(hMsg.hData);
 ...
 */
p.trackStat = function(sStat,aParams,fnCallback,dDate,nFakeCount){
    var oSelf = this;
