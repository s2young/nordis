                    ...
                    if (!sClass && hSettings.hExtras[sProperty].sType.match(/(Object|Collection)/))
                        ...
                        switch (hSettings.hExtras[sProperty].sType) {
                                ...
                                async.series([
                                    ...
                                    ,function(cback){
                                        if (!hOpts || !hOpts.hExtras || !oSelf[sProperty].aObjects || !oSelf[sProperty].aObjects.length)
                                            ...
                                            var n = -1;
                                            async.forEach(oSelf[sProperty].aObjects,function(oItem,cb){
                                                n++;
                                                oSelf[sProperty].aObjects[n] = (oItem instanceof Base) ? oItem : Base.lookup({sClass:oSelf[sProperty].sClass,hData:oItem});
                            ...
                            case 'Hash':case 'Array':
                                oSelf[sProperty] = (hSettings.hExtras[sProperty].sType=='Hash') ? {} : [];
                                if (hSettings.hExtras[sProperty].fnQuery) {
