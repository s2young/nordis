...
p.getRedisKey = function(sKeyValue,sTenantProperty) {
    var oSelf = this;
    var _sRedisKey = oSelf.nClass || oSelf.getSettings().nClass || oSelf.sClass;

    if (sTenantProperty)
        _sRedisKey += ':'+sTenantProperty;
    else if (oSelf.getSettings().sTenantProperty && oSelf.get(oSelf.getSettings().sTenantProperty)) {
