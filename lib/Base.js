                            ...
                            case 'Hash':case 'Array':
                                ...
                                if (hSettings.hExtras[sProperty].fnQuery) {
                                    if (hSettings.hExtras[sProperty].bCallback) {
                                        console.log(hSettings.hExtras[sProperty].sType+' 1');
                                        hSettings.hExtras[sProperty].fnQuery(oSelf,Config,function(){
                                            console.log(hSettings.hExtras[sProperty].sType+' 1 done');
                                            callback();
                                        });
                                    } else {
                                        console.log(hSettings.hExtras[sProperty].sType+' 2');
                                        hSettings.hExtras[sProperty].fnQuery(oSelf,Config);
                                        console.log(hSettings.hExtras[sProperty].sType+' 2 done');
                                        callback();
                                    }
                                } else
                                    callback();
