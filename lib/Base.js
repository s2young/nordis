        ...
        if (hOpts && hOpts.hPropertyOpts && hOpts.sProperty && hOpts.sProperty != 'sSource') {
            ...
            switch (sProperty.substring(0,1)) {
                ...
                case 's':
                    ...
                    break;
                case 'o':
                    var sClass = (hSettings.hExtras[sProperty].sClass) ? hSettings.hExtras[sProperty].sClass : null;
                    // Some object extras are dynamic in their class, which will be indicated by the presence of a fnGetClass property in conf.js.
                    if (hSettings.hExtras[sProperty].fnGetClass)
