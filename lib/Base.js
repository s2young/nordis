                        ...
                        switch (hSettings.hExtras[sProperty].sType) {
                            ...
                            case 'Collection':
                                ...
                                if (hSettings.hExtras[sProperty].fnQueryOverride) {
                                    ...
                                    if (hOpts.hExtras) {
                                        if (hOpts.hExtras.nMin) hCustom.nMin = hOpts.hExtras.nMin;
                                        if (hOpts.hExtras.nMax) hCustom.nMax = hOpts.hExtras.nMax;
                                        if (hOpts.hExtras.bReverse) hCustom.bReverse = hOpts.hExtras.bReverse;
                                    }
                                    if (hCustom.nMax != undefined) nMax = hCustom.nMax;
                                    if (hCustom.nMin != undefined) nMin = hCustom.nMin;
                                    if (hCustom.bReverse != undefined) bReverse = hCustom.bReverse;
                                }
                            ...
                            if (hSettings.hExtras[sProperty].fnQuery) {
                                ...
                                ////Config.debug('Hash property is missing fnQuery: '+sProperty+' ON '+oSelf.sClass);
                                callback();
                            }
                            break;
                            case 'Boolean':
