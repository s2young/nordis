            ...
            if (fnCallback) {
                ...
                async.waterfall([
                    ...
                    ,function(oObj,callback) {
                        AppConfig.MySql.loadObject(hOpts,oSelf,function(err,oClient){
                            if (!err && hOpts && hOpts.hExtras)
                                oSelf.loadExtras(hOpts.hExtras,function(err){
                                    AppConfig.MySql.release(oClient);
                                    callback(err,oSelf);
                                },oClient);
                            else {
                                AppConfig.MySql.release(oClient);
                    ...
                    switch (hSettings.hExtras[sProperty].sType) {
                        ...
                        case 'Object':
                            ...
                            async.series([
                                ...
                                ,function(cback){
                                    if (hQuery && !oParent[sProperty].getKey())
                                        AppConfig.MySql.loadObject({hQuery:hQuery},oParent[sProperty],function(err,oResult){
