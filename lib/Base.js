                    ...
                    if (!sClass && hSettings.hExtras[sProperty].sType.match(/(Object|Collection)/))
                        ...
                        switch (hSettings.hExtras[sProperty].sType) {
                            case 'Increment':
                                ...
                                if (oSelf.getKey())
                                    Config.Redis.get(oSelf.getRedisKey()+':'+sProperty,function(err,res){
            ...
            function(callback) {
                ...
                switch (hSettings.sType) {
                    case 'Collection':
                        ...
                        break;
                    case 'Increment':
                        Config.Redis.del(oSelf.getRedisKey()+':'+sProperty, function (err) {
                            callback(err,oSelf[sProperty]);
                        });
...
p.getRedisKey = function(sKeyValue) {
    if (!this._sRedisKey) {
        ...
        if (this.getSettings().sTenantProperty && this.get(this.getSettings().sTenantProperty)) {
            console.log(this._sRedisKey,this.getSettings().sTenantProperty);
