    ...
    if (sProperty && this.hData && this.getSettings().hProperties[sProperty] && !this.getSettings().hProperties[sProperty].bReadOnly) {
        ...
        switch (this.getSettings().hProperties[sProperty].sType) {
            ...
            case 'Decimal':
                ...
                console.log(sProperty+', y='+y+', scale='+scale+', '+this.hData[sProperty]);
                break;
            default:
...
p.save = function(hOpts,fnCallback) {
    ...
    if (oSelf.sClass=='Directory')
        console.log('oSelf.getSettings().sStrKeyProperty',oSelf.getSettings().sStrKeyProperty);
