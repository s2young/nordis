...
p.processExtras = function(bNew,hDelta,bRemoved,fnCallback) {
    ...
    if (Config.hExtrasByClass[oSelf.sClass])
        async.each(Config.hExtrasByClass[oSelf.sClass],function(hOpts,callback) {
            if (oSelf.sClass=='Directory') console.log(hOpts,Config.hClasses[hOpts.sParent].hExtras[hOpts.sExtra].fnCreate.toString());
            ...
            if (!Config.hClasses[hOpts.sParent].hExtras[hOpts.sExtra].fnCreate)
                callback();
            else
