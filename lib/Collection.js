        ...
        if (hOpts.aObjects) {
            ...
            Config.MySql.loadCollection({
                ...
                if (err) {
                    ...
                    var n = 0;
                    async.forEach(oSelf.aObjects,function(hItem,cb){
...
p.concat = function(obj) {
    var oSelf = this;
    if (obj) {
        if (obj instanceof Collection) {
            oSelf.aObjects = oSelf.aObjects.concat(obj.aObjects);
            oSelf.nTotal += obj.aObjects.length;
            oSelf.nCount += obj.aObjects.length;
        } else if (obj instanceof Array) {
            oSelf.aObjects = oSelf.aObjects.concat(obj);
            oSelf.nTotal += obj.length;
            oSelf.nCount += obj.length;
        }
    }
};
