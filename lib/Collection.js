...
function Collection(hOpts,fnCallback) {
    ...
    if (hOpts && hOpts.sClass) {
        ...
        if (AppConfig.hClasses[oSelf.sClass] && AppConfig.hClasses[oSelf.sClass].nClass)
            oSelf.nClass = AppConfig.hClasses[oSelf.sClass].nClass;
    }
    if (hOpts && hOpts.nClass) {
        oSelf.nClass =  hOpts.nClass;
        if (AppConfig.hClassMap[oSelf.nClass])
            oSelf.sClass = AppConfig.hClassMap[oSelf.nClass];
    }
    ...
    if (hOpts) {
        if (hOpts.aObjects) {
        ...
        } else if (hOpts.hQuery && !AppConfig.MySql.hOpts.bSkip) {
            ...
            AppConfig.MySql.loadCollection({
                ...
                if (err)
                    ...
                    var loadItem = function(oItem,cb){
...
module.exports.lookup = function(hOpts,fnCallback) {
    new Collection(hOpts,fnCallback);
};
/**
 ...
 * @param fnCallback
 */
module.exports.findAll = function(hOpts,fnCallback) {
    if (hOpts && hOpts.sClass) {
