                    ...
                    var processRedisMetric = function(hIncrement,cb2) {
                        ...
                        async.parallel([
                            ...
                            ,function(cb3) {
                                ...
                                if (hIncrement.year!=null) aKeyParts.push(hIncrement.year);
                                if (hIncrement.month!=null) aKeyParts.push(hIncrement.month);
                                if (hIncrement.day!=null) aKeyParts.push(hIncrement.day);
                                if (hIncrement.hour!=null) aKeyParts.push(hIncrement.hour);
