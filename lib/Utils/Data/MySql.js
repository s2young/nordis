...
p.execute = function(hOpts,sQuery,aValues,fnCallback) {
    var oSelf = this;
    if (hOpts instanceof String && sQuery instanceof Array && aValues instanceof Function) {
        fnCallback = aValues;
        aValues = sQuery;
        sQuery = hOpts;
        hOpts = {};
    } else if (hOpts instanceof String && sQuery instanceof Function) {
        fnCallback = sQuery;
        sQuery = hOpts;
        aValues = null;
        hOpts = {};
    } else if (hOpts instanceof Object && sQuery instanceof String && aValues instanceof Function) {
        fnCallback = aValues;
        aValues = null;
    }
    
    var sDbAlias = hOpts.sDbAlias || 'default';
    oSelf.acquire(function(err, oClient) {
        if (err) {
