        ...
        if (err)
            ...
            async.waterfall([
                ...
                function(nuttin,callback) {
                    ...
                    var sWhere = 'SELECT T.*,S.nScore,S.RefID AS RefID FROM '+cColl.sClass+'Tbl T RIGHT OUTER JOIN _SortedSetTbl S ON T.nID = S.RefID WHERE S.RefID IS NOT NULL AND  S.sID IN (\''+hOpts.aKeys.join('\',\'')+'\') '+sMin+sOrderBy+sLimit+';';
