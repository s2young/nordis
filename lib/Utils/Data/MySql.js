                ...
                if (!hSettings.hExtras[sProperty]) {
                    ...
                    switch (hSettings.hExtras[sProperty].sType) {
                        ...
                        case 'Object':
                            ...
                            var sClass = (hSettings.hExtras[sProperty].sClass) ? hSettings.hExtras[sProperty].sClass : (oObj.get('nObjectClass')) ? App.hClassMap[oObj.get('nObjectClass')] : null;
                            if (!sWhere) {
                            ...
                            App.debug('SELECT * FROM '+sClass+'Tbl WHERE '+sWhere);
                            oClient.query('SELECT * FROM '+sClass+'Tbl WHERE '+sWhere,null,function(err,aResults){
                                if (err) {
                                    callback(err);
                                } else {
                                    if (!oObj[sProperty]) {
