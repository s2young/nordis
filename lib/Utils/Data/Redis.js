            ...
            if (oObj.hSettings().hExtras) {
                for (var sProp in oObj.hSettings().hExtras) {
                    if (oObj.hSettings().hExtras[sProp].aKey && oObj.get(oObj.hSettings().hExtras[sProp].aKey[0])) {
                        var sClass = oObj.hSettings().hExtras[sProp].sClass;
                        if (!sClass && oObj.hSettings().hExtras[sProp].fnGetClass)
                            sClass = oObj.hSettings().hExtras[sProp].fnGetClass(oObj,App);
                        if (sClass) {
