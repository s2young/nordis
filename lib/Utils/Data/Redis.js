                            ...
                            async.waterfall([
                                ...
                                ,function(nStart,cb){
                                    if (!hOpts.nMin && !!hOpts.nMax) {
                                        ...
                                        oClient.zrevrangebyscore(oClient.sHashKey+hOpts.sKey,oObj.nMin,oObj.nMax,handleResult);
                                    else
                                        oClient.zrangebyscore(oClient.sHashKey+hOpts.sKey,oObj.nMin,oObj.nMax,handleResult);
