                ...
                oSelf.acquire(function(err,oResult){
                    ...
                    if (hOpts.hQuery[sKeyProperty]) {
                        ...
                        for (var sLookup in hOpts.hQuery) {
                            ...
                            if (oObj.getSettings().hProperties[sLookup].bUnique)
                    ...
                    async.waterfall([
                        function(cb){
                            ...
                            if (!oObj.sFirstID)
                                ...
                                AppConfig.Redis.dbPool[sDbAlias].zrevrank(hOpts.sKey,oObj.getClass()+':'+oObj.sFirstID,cb);
                            else
                                AppConfig.Redis.dbPool[sDbAlias].zrank(hOpts.sKey,oObj.getClass()+':'+oObj.sFirstID,cb);
                        }
                        ,function(nStart,cb){
