...
p.acquire = function(fnCallback,sDbAlias,nRetry) {
    ...
    if (!oSelf.dbPool || !oSelf.dbPool[sDbAlias]) {
        ...
        oSelf.dbPool[sDbAlias].on('end',function(){
            delete oSelf.dbPool[sDbAlias];
        });
        oSelf.dbPool[sDbAlias].on('error',function(err){
            delete oSelf.dbPool[sDbAlias];
        });
        oSelf.dbPool[sDbAlias].on('connect',function(err){
...
p.acquirePub = function(fnCallback,sDbAlias) {
    ...
    if (!oSelf.dbPubPool || !oSelf.dbPubPool[sDbAlias]) {
        ...
        console.log('acquirePub: '+oSelf.hOpts[sDbAlias].nPort+','+oSelf.hOpts[sDbAlias].sHost,opts);
...
p.acquireSub = function(fnCallback,sDbAlias) {
    ...
    if (!oSelf.dbSubPool || !oSelf.dbSubPool[sDbAlias]) {
        ...
        console.log('acquireSub: '+oSelf.hOpts[sDbAlias].nPort+','+oSelf.hOpts[sDbAlias].sHost,opts);
