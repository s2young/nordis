                                        ...
                                        if (aResult) {
                                            ...
                                            oClient.mget(aResult,function(err,aItems){
                                                if (err || !aItems || !aItems.length)
                                                    ...
                                                    console.log(aItems);
                                                    console.log(aItems.length,aResult.length);

                                                    var bMissing;
                                                    async.forEachOf(aItems,function(hData,n,cb2){
                                                        if (!hData) {
                                                            console.log('zrem '+aResult[n]);
                                                            bMissing = true;
                                                            oClient.zrem(oClient.sHashKey+hOpts.sKey,aResult[n],cb2);
                                                        } else if (n == aItems.length-1) {
                                                            console.log('sFirstID:'+oObj.sFirstID);
                                                        ...
                                                        if (bMissing) oObj.nTotal = oObj.aObjects.length;
                                                        cb(err);
                                                    });
