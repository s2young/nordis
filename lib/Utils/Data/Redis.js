            ...
            if (oObj.hSettings().hExtras) {
                for (var sProp in oObj.hSettings().hExtras) {
                    if (oObj.hSettings().hExtras[sProp].aKey && oObj.get(oObj.hSettings().hExtras[sProp].aKey[0]))
                        multi.hset(oObj.nClass+':'+oObj.get('nID')+':MAP',oObj.nClass+':'+oObj.get('nID')+':'+sProp,App.hClasses[oObj.hSettings().hExtras[sProp].sClass].nClass+':'+oObj.get(oObj.hSettings().hExtras[sProp].aKey[0]));
                        if (nTTL)
