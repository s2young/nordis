                ...
                async.waterfall([
                    function(callback){
                        if (hOpts && (hOpts.nMin || hOpts.nMax)) {
                            ...
                            hOpts.nMax = (hOpts.nMax) ? parseFloat(hOpts.nMax) : 726081834000;
                            if (oObj.bReverse)
                    ...
                    ,function(res,callback){
                        ...
                        if (hOpts && hOpts.nMin)
                            console.log(oClient.sHashKey+hOpts.sKey+','+hOpts.nMin+','+hOpts.nMax+'; nTotal:'+oObj.nTotal);
        ...
        oSelf.acquire(function(err,oClient){
            if (err)
                ...
                if (hOpts && hOpts.sKey) {
                    ...
                    if (hOpts.sKey.match('cPublicEvents'))
                        console.log(oClient.sHashKey+hOpts.sKey+','+nScore,[oClient.sHashKey+oObj.getClass()+':'+oObj.getKey()]);
