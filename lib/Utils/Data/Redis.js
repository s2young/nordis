                ...
                async.series([
                    ...
                    ,function(cb) {
                        if (oObj.getSettings().aSecondaryLookupKeys) {
                            async.forEachOf(oObj.getSettings().aSecondaryLookupKeys,function(sProp,n,cb2){
                                if (oObj.get(sProp))
                                    oClient.hset(oClient.sHashKey+'KEYS',oObj.getClass()+':'+oObj.get(sProp),oObj.getRedisKey(),cb2);
                                else
                                    cb2();
                            },cb);
