            ...
            if (err)
                ...
                if (oObj.getSettings().aSecondaryLookupKeys)
                    oObj.getSettings().aSecondaryLookupKeys.forEach(function(sProp){
                        if (oObj.get(sProp) && oObj.getRedisKey() && (oObj.bNew || (oObj.hDelta && oObj.hDelta[sProp]) || (hOpts && hOpts.bForce)))
                            oClient.hset(oClient.sHashKey+'KEYS',oObj.getClass()+':'+oObj.get(sProp),oObj.getRedisKey());
                    });
            ...
            if (err)
                ...
                if (hOpts && hOpts.sKey) {
                    ...
                    if (isNaN(nScore)) {
                        ...
                        if (oClient.sHashKey+hOpts.sKey)
