        ...
        async.series([
            ...
            ,function(cb){
                if (!req.hNordis.hEndpoint) {
                    ...
                    Config.debug(req.hNordis.sPath+' -- '+req.hNordis.sEndpoint);
                    cb();
                }
            }
            ...
            ,function(cb) {
                ...
                if (fnApiCallProcessor) {
                    Config.debug('Found fnApiCallProcessor. Run it.');
                    ...
                    Config.debug('No fnApiCallProcessor. Using default middleware path.');
