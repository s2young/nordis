...
var preParse = function(req,res,next) {
    ...
    if (req.body || req.query)
        req.hNordis.hExtras = (req.method == 'POST' && req.body) ? req.body.hExtras : (req.query && req.query.hExtras && req.query.hExtras instanceof Object) ? req.query.hExtras : (req.query && req.query.hExtras && req.query.hExtras instanceof String) ? JSON.parse(req.query.hExtras) :null;
