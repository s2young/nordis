...
var preParse = function(req,res,fnCallback) {
    ...
    var aPath = req.path.toLowerCase().split('/');
    req.hNordis.sClass = (aPath && aPath[1] && App.hClassMap[aPath[1]]) ? App.hClassMap[aPath[1]] : null;
    ...
    if (!req.hNordis.sAction || !req.hNordis.sClass) {
        ...
        req.hNordis.hQuery[req.hNordis.sLookupProperty] = aPath[2];
