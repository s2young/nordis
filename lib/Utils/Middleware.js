...
var clientHelper = function(req,res,next) {
    if (req.path.match(/\/_nordis_/)) {
        if (!AppConfig.sConfVersion)
            ...
            var current_version = '/_nordis_client_'+AppConfig.sConfVersion+'.js';
            ...
            switch (req.path) {
                ...
                case '/_nordis_client/version.js':
                    ...
                    res.end('define(function (require, exports, module) {exports.version = "'+AppConfig.sConfVersion+'"});');
                    break;
                ...
                case current_version.replace('.js','.min.js'):
                    ...
                    if (process.env[current_version])
                        ...
                        var hContext = {hClasses:{},hApiCalls:{}};
                        ...
                        Template.compile(__dirname+'/angular.nordis.tpl',hContext,function(err,text){
                            if (err)
                                ...
                                if (req.path.match(/\.min/)) {
                                    ...
                                    var result = UglifyJS.minify(text, {fromString: true});
