        ...
        async.series([
            ...
            function(cb) {
                ...
                if (req.hNordis.oResult || req.hNordis.bMetric || !req.hNordis.sClass || !Config.hClasses[req.hNordis.sClass]) {
                    Config.debug('preParse 1a: ',req.hNordis);
                    cb();
            ...
            ,function(cb){
                ...
                if (req.hNordis.hResult) {
                    ...
                    req.hNordis.oResult.loadExtras(req.hNordis.hExtras,function(err) {
                        Config.debug('preParse 4b: '+req.hNordis.sPath);
                        if (err) {
                            console.error(err);
                            cb(err);
                        } else {
                            Config.debug('preParse 4c: '+req.hNordis.sPath);
                            ...
                            Config.debug('preParse 4d: '+req.hNordis.sPath);
                            cb();
                        }
                    });
