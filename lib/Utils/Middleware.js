                ...
                if (req.path == hItem.sEndpoint) {
                    ...
                    if (aMatches) {
                        ...
                        for (var n = 0; n < Config.hEndpointKeywords[aPaths[1]].length; n++) {
                            if (req.path == Config.hEndpointKeywords[aPaths[1]][n].sEndpoint) {
        ...
        async.series([
            ...
            ,function(cb){
                ...
                if (!req.hNordis.hEndpoint) {
                    ...
                    Config.debug(req.hNordis.sEndpoint);
                    cb();
                }
            }
            ...
            ,function(cb){
                ...
                if (req.hNordis.oResult && req.hNordis.hExtras) {
                    Config.debug('LOAD EXTRAS');
                    Config.debug(req.hNordis.hExtras);
            ...
            ,function(cb) {
                ...
                if (fnApiCallOutput)
                    ...
                    console.log(req.hNordis.oResult);
