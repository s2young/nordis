...
(function() {
    var nordis = angular.module('nordis', window.aAngularMods);

    nordis.directive('onKeyup', function($parse) {
    ...
    nordis.directive('modalDialog', function() {
            return {
                restrict: 'E',
                scope: {
                    show: '='
    ...
    nordis.directive('nordisOnload',function(){
    ...
    nordis.factory('helpers',function($rootScope,$http,$location){
            var self = this;
    ...
    nordis.filter('startFrom', function() {
    ...
    nordis.factory('AppConfig',function(helpers){
            return {hClasses:{
    ...
    nordis.factory('[[=sClass]]',function(AppConfig){
